...
import { ContractTemplatesViewComponent } from './components/contract-templates-view/contract-templates-view.component';
...
const appRoutes: Routes = [
  ...
  { path: 'backoffice/service/taxtypes/create', component: TaxTypesComponent },
  { path: 'backoffice/service/services/create', component: ServicesComponent },
  { path: 'backoffice/service/servicetypes', component: ServiceTypesComponent },
  { path: 'backoffice/service/postpaid/create', component: PostpaidServicesCreateComponent },
  { path: 'backoffice/service/prepaid/create', component: PrepaidServicesCreateComponent },
  { path: 'backoffice/service/postpaid', component: PostpaidServicesComponent },
  { path: 'backoffice/service/postpaid/view/:id', component: PostpaidServicesViewComponent },
  { path: 'backoffice/service/prepaid', component: PrepaidServicesComponent },
  { path: 'backoffice/service/prepaid/view/:id', component: PrepaidServicesViewComponent },
  { path: 'backoffice/groups', component: GroupsComponent },
  { path: 'backoffice/group/create', component: GroupCreateComponent },
  { path: 'backoffice/contract-templates/view/:id', component: ContractTemplatesViewComponent },
  ...
  { path: 'backoffice/tariffs', component: TariffsComponent },
  ...
  { path: 'backoffice/customers/:customerId/prepaid-contract/:contractId/create', component: PrepaidContractComponent },

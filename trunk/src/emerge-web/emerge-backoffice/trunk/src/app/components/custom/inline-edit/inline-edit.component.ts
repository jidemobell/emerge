import {Component, Input, Output, forwardRef, EventEmitter, ElementRef, ViewChild, Renderer, OnInit} from '@angular/core';
    ...
    setTimeout(_ => {
      switch (this.typeIndex) {
        case 0:
          ...
          break;
        case 1:
          this.inlineTextAreaControl.nativeElement.focus();
          break;
        case 2:

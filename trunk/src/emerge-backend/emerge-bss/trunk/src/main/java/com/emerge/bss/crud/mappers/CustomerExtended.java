...
public class CustomerExtended {
    ...
    private String country = null;
     ...
     @ApiModelProperty(value = "")
    public Date getDbCdate() {
        return dbCdate;
    }

    public void setDbCdate(Date dbCdate) {
        this.dbCdate = dbCdate;
    }
    
    private Date dbCdate;
    ...
    private List<ContractPrepaid> contractPrepaids = new ArrayList<>();

    private String tags = null;

    public CustomerExtended id(Long id) {
        this.id = id;
        return this;
    }
  ...
  *
    ...
    public CustomerExtended status(String status) {
        this.status = status;
        return this;
    }
  ...
  *
    ...
    public CustomerExtended name(String name) {
        this.name = name;
        return this;
    }
  ...
  *
    ...
    public CustomerExtended fiscalNumber(String fiscalNumber) {
  ...
  *
    ...
    public CustomerExtended taxExemptionCertificates(String taxExemptionCertificates) {
        this.taxExemptionCertificates = taxExemptionCertificates;
        return this;
    }

    public CustomerExtended addTaxExemptionCertificateItem(String taxExemptionCertificatesItem) {
  ...
  *
    ...
    public CustomerExtended country(String country) {
  ...
  *
    ...
    public CustomerExtended website(String website) {
  ...
  *
    ...
    public CustomerExtended privateNotes(String privateNotes) {
  ...
  *
    ...
    public CustomerExtended publicNotes(String publicNotes) {
  ...
  *
    ...
    public CustomerExtended notifyBySms(String notifyBySms) {
  ...
  *
    ...
    public CustomerExtended notifyByEmail(String notifyByEmail) {
  ...
  *
    ...
    public CustomerExtended mainContact(Contact mainContact) {
  ...
  *
    ...
    public CustomerExtended customerAddresses(List<CustomerAddress> customerAddresses) {
        this.customerAddresses = customerAddresses;
        return this;
    }

    public CustomerExtended addCustomerAddressesItem(CustomerAddress customerAddressesItem) {
  ...
  *
    ...
    public CustomerExtended tags(String tags) {
        this.tags = tags;
        return this;
    }

    public CustomerExtended addTagsItem(String tagsItem) {
        this.tags = tagsItem;
        return this;
    }
  ...
  *
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CustomerExtended customer = (CustomerExtended) o;
        return Objects.equals(this.id, customer.id)
                ...
                && Objects.equals(this.contractPrepaids, customer.contractPrepaids)
                && Objects.equals(this.email, customer.email)
                && Objects.equals(this.phoneNumber, customer.phoneNumber)
                && Objects.equals(this.dbCdate, customer.dbCdate)
                && Objects.equals(this.tags, customer.tags);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, status, name, fiscalNumber, taxExemptionCertificates, country, website, privateNotes, publicNotes, notifyBySms, notifyByEmail, mainContact, customerAddresses, tags,contractPrepaids,email,phoneNumber);
    }
    ...
    public String toString() {
        ...
        sb.append("    contractPrepaids: ").append(toIndentedString(contractPrepaids)).append("\n");
        sb.append("    phoneNumber: ").append(toIndentedString(phoneNumber)).append("\n");
        sb.append("    email: ").append(toIndentedString(email)).append("\n");
        sb.append("    tags: ").append(toIndentedString(tags)).append("\n");
        sb.append("    dbCdate: ").append(toIndentedString(dbCdate)).append("\n");
        sb.append("}");
        return sb.toString();
    }
    ...
    private String toIndentedString(java.lang.Object o) {
     ...
     @ApiModelProperty(value = "")
    public List<ContractPrepaid> getContractPrepaids() {
        return contractPrepaids;
    }

    public void setContractPrepaids(List<ContractPrepaid> contractPrepaids) {
        this.contractPrepaids = contractPrepaids;
    }
}

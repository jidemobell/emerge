...
public class ConfigData   {
  ...
  **/
  ...
  public ConfigData keepAliveInterval(int keepAliveInterval) {
  ...
  **/
  ...
  public ConfigData sendErrorsToOCS(int sendErrorsToOCS) {
  ...
  **/
  ...
  public ConfigData silenceMode(Boolean silenceMode) {
   ...
   /**
   * Put the payphone in silence mode - it will eliminate all dialogs except keepAlive, which will be done every 24h
   * @return silenceMode
  **/
  @ApiModelProperty(value = "Put the payphone in silence mode - it will eliminate all dialogs except keepAlive, which will be done every 24h")
